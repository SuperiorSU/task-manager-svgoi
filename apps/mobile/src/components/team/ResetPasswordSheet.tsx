/**
 * ResetPasswordSheet — bottom sheet (screen 39).
 *
 * Lock icon + title · user card with email
 * Bullet list: 15-min link · all sessions signed out
 * [Send reset link] (primary) · [Cancel]
 */
...
export const ResetPasswordSheet = React.memo(({ member, visible, onConfirm, onDismiss }: Props) => {
        ...
        <View style={[s.sheet, { backgroundColor: colors.surface.card }]}>
          ...
          <View style={s.headerRow}>
            ...
            <View style={s.headerText}>
              ...
              <Text style={[s.sheetSub, { color: '#64748B' }]}>
                Sends a secure reset link by email
              </Text>
            </View>
          </View>
          ...
          <View style={[s.userRow, { backgroundColor: '#F8FAFC', borderColor: '#EEF2F7' }]}>
            ...
            <View style={s.userInfo}>
              ...
              <Text style={[s.userEmail, { color: colors.text.tertiary }]}>{member.email}</Text>
            </View>
          </View>
          ...
          <View style={s.bullets}>
            <BulletItem colors={colors}>
              A 15-minute reset link is emailed to {member.name.split(' ')[0]}.
            </BulletItem>
            <BulletItem colors={colors}>
              All their active sessions are signed out.
            </BulletItem>
          </View>
